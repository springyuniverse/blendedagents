    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50" style={{ marginLeft: 0 }}>
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-semibold text-gray-900 tracking-tight">BlendedAgents</h1>
          <p className="text-sm text-gray-500 mt-1">Tester Dashboard</p>
        </div>

        <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
          <h2 className="text-base font-medium text-gray-900 mb-6 text-center">Sign in to your account</h2>
          ...
          <p className="mt-4 text-xs text-gray-500 text-center">
            Your Google account must be pre-registered by an administrator.
          </p>
        </div>
      </div>
    </div>
